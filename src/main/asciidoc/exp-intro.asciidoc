...
Z <<hp-alphaParam>> je patrné, že pro alpha parametr poskytují lepší výsledky vyšší hodnoty než výchozí hodnota 1. Pro další vzpočty použijeme hodnotu hyper parametru alpha 10.        
