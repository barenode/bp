...
Pro tento přklad vyhodnotí Spark následující plán zpracování, kde se čísla na konci řádků odkazují na řádky ve uvedeném zdrojovém kódu:
