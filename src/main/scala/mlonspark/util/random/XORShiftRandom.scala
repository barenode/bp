...
import mlonspark.util.Utils.timeIt
 ...
 * for each thread.
 */
private[mlonspark] class XORShiftRandom(init: Long) extends JavaRandom(init) {
...
private[mlonspark] object XORShiftRandom {
